...
Çıktılar:
  ...
  - {FR_OUTPUT_DIR}/feature_importances_stacking_fr09.csv
  - {FR_OUTPUT_DIR}/shap_feature_importance_fr09.csv   (shap varsa)
"""
...
def main() -> None:
    ...
    with open(raw_path, "r", encoding="utf-8", errors="ignore", newline="") as fin, \
        ...
        for i, row in enumerate(reader, start=2):
            if len(row) == expected_cols:
                ...
                bad_rows += 1
                # GitHub loglarını boğmamak için sadece sayıyı tutmak yeterli,
                # istersen buradaki print'i yoruma alabilirsin.
    ...
    # ============================================================
    # 3) 3-SAATLİK ZAMAN ARALIĞI & PIVOT (Son 30 gün)
    #    (Şu an sadece log amaçlı, forecasting adımı pipeline’ın başka
    #     scriptlerinde kullanılabilir)
    # ============================================================
    ...
    geojson_geo_col = "geoid"  # GeoJSON tarafında GEOID kolonu
    ...
    try:
        ...
        # SHAP için sadece numerik feature'ları ve makul bir örneklem alalım
        ...
        # Binary durumda shap_values list olabilir → pozitif sınıfı al
